...
As the ligand has to be transported to this site from the protein outer environment, it is crucial to find a feasible trajectory, which the ligand can follow.
There are several in-silico methods, enabling to calculate potential trajectories. 
They usually produce large ensembles of trajectories which have to be further explored by the biochemists who are trying to assess their relevance. 
This decision is based on many parameters of the trajectories which have to be taken into account.
...
In this paper, we introduce our tool for visual analysis of ligand trajectories and their various properties.
...
It is composed of several linked views, enabling interactive exploration and filtering of trajectories.
The tool consists of a set of 2D views and the 3D view.
It utilizes the concept of a small multiples for communicating different properties of the trajectories.
